...
BASE_CONFIGS_PATH = "/cpfs01/shared/NLP-A100/NLP-A100_hdd/jie/multilingual_LLM/configs/A100-glm/"
...
def get_args(parser):
    parser.add_argument('--cfg', type=str, default="/cpfs01/shared/NLP-A100/NLP-A100_hdd/jie/multilingual_LLM/configs/A100-glm/total_inference.yaml", help='model name in the hub or local path')
